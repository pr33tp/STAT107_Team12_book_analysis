...
# (You can switch manually between 1910s and 2010s as needed)
...
stop_words <- c("a", "an", "the", "but", "or", "that", "so", 
                "of", "to", "in", "for", "with", "for", "i")
pattern <- paste0("\\b(", paste(stop_words, collapse = "|"), ")\\b")
cleaned_text_1910s <- str_replace_all(
  books_1910s, regex(pattern, ignore_case = TRUE), ""
)
...
stop_words <- c("a", "an", "the", "but", "or", "that", "so", 
                "of", "to", "in", "for", "with", "for", "i")
pattern <- paste0("\\b(", paste(stop_words, collapse = "|"), ")\\b")
cleaned_text_2010s <- str_replace_all(
  books_2010s, regex(pattern, ignore_case = TRUE), ""
)
